                ...
                <div class="profile">
                    ...
                    <div class="card" style="height: 100%;">
                        <div class="card-body" style="display: flex; flex-direction: column;">
                            <div class="image_area" style="margin: auto; padding: 40px;">
                                <form method="post">
				    ...
				    <div class="input-group mb-3">
                                    ...
                                    <div class="center-btn">
                                        <button class="profile-update" id="btn-submit" style="font-weight:500; margin-right: 10px;">Update Profile</button>
                                        <button class="profile-update" id="btn-submit" style="font-weight:500">Delete Profile</button>
                                    </div>
                                </div>
                            </form>
                        </div>
