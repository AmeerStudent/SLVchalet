...
<!--               <li th:if="${#session.containsKey('User')}"> 
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                <li><a style="text-decoration: none;" href="/updateprofile">Update Profile</a></li>
                                <li><a style="text-decoration: none;" href="/updatepassword">Change Password</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
    ...
    <div class="container">
		<div class="row">
			<div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="50">
              <img src="assets/img/slv.png" class="img-fluid" alt="">
			</div>
  ...
  <script>
     $(document).ready(function(){
        $("form").submit(function(event) {
          ...
          $(".form-message").load("inc/staff.php", {
              username: username,
              password: password
            });
          });
