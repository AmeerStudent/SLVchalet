...
<head>
  ...
  <title>Sungai Lopo Reservation</title>
  ...
  <div class="container" style="margin-top:10%; border:1px">
    <div class="row">
      ...
      <div class="col-lg-6 d-flex flex-column">
        ...
        <textarea name="" id="" cols="30" rows="10" ><?php echo $prod['product_des']; ?></textarea>
        ...
        <tr>
                            <td><h4 style="font-weight:1000">Ticket Date : </h4></td>
                            <td><input type="date" name="fdate" onfocus="this.min=new Date().toISOString().split('T')[0]"></td>
