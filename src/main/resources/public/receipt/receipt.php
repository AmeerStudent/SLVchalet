...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="container mt-5 mb-5">
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="text-left logo p-2 px-5"> <img src="slv.png" width="160"> </div>
                    <div class="invoice p-5">
                        <h5>Your Booking Confirmed!</h5> <span class="font-weight-bold d-block mt-4">Hello, <?php echo $row['username'] ?></span> <span>You booking has been confirmed </span>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="60%"> <span class="font-weight-bold"><?php echo $fetchrow['product_title'] ?></span>
                                                <div class="product-qty"> <span class="d-block">Quantity:<?php echo $fetchrow['var_product_quan']; ?></span> <span>Variation : <?php echo $fetchrow['var_product_title'] ?></span> <span class="d-block">Date : <?php echo $fetchrow['var_product_title']; ?></span></div>
                                            </td>
                                            <td width="20%">
                        ...
                        <p class="font-weight-bold mb-0">Thanks for booking with us!</p> <span>Sungai Lopo Village</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between footer p-3"> <span>Sungai Lopo Village</span></div>
                </div>
            </div>
        </div>
    </div>
