...
$query2 = "SELECT * FROM user WHERE username = '$usernameSESSION' ";
...
<head>
  ...
  <title>SLV</title>
  <link rel="icon" href="images/slv.png" type="image/gif" />
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <nav class="navbar navbar-dark bg-dark" style="background-color: #F4F9F9;">
    <a class="navbar-brand" href="../index.php">
      <img src="images/slv.png" style=" filter: invert(100%);-webkit-filter: invert(100%); margin-left: 40px;" width=150px; alt="">
    </a>
  </nav>
  <div class='container'>
    <div class='window'>
            ...
            <table class='order-table' style="margin-bottom:20px; text-align:center;">
              <tbody>
                <tr>
                  ...
                  <td>
                    <h3>Member Discount : <?php echo 'RM ', $totaldisc ?></h3>
