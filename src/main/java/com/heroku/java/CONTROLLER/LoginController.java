    ...
    public String login(@RequestParam(name = "success", required = false) Boolean success, String inputUsername, String inputPassword, HttpSession session, Model model, customer customer) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                System.out.println("Customer username : " + inputUsername.equals(custUsername) + " | " + custUsername);
                System.out.println("Password : " + inputPassword.equals(custPass));
                if (inputUsername.equals(custUsername) && inputPassword.equals(custPass))
                 {

                    session.setAttribute("inputUsername", custUsername);
                    session.setAttribute("inputPassword", custPass);
